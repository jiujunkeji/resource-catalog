 ...
 **本地部署**
- 通过git下载源码
- 创建数据库resource_catalog，数据库编码为UTF-8
- 执行db/mysql.sql文件，初始化数据【按需导入表结构及数据】
- 修改application-dev.yml文件，更新MySQL账号和密码
- 在resource-catalog目录下，执行mvn clean install
<br>
 ...
 **项目演示**
- 演示地址：http://demo.open.renren.io/resource-catalog
- 账号密码：admin/admin
...
- gitee仓库：https://gitee.com/renrenio/resource-catalog
- github仓库：https://github.com/renrenio/resource-catalog
